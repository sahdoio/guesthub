...
use Modules\Guest\Infrastructure\Persistence\QueryBuilderGuestProfileRepository;

final class GuestServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        $this->app->bind(GuestProfileRepository::class, QueryBuilderGuestProfileRepository::class);
    }
