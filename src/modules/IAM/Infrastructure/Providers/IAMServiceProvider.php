...
use Modules\IAM\Infrastructure\Persistence\Eloquent\EloquentAccountGuestRepository;
...
final class IAMServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(AccountGuestRepository::class, EloquentAccountGuestRepository::class);
