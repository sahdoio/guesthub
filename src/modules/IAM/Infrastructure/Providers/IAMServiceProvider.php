...
use Modules\IAM\Infrastructure\Persistence\Eloquent\EloquentHotelRepository;
use Modules\IAM\Infrastructure\Persistence\Eloquent\EloquentEmailUniquenessChecker;
use Modules\IAM\Infrastructure\Persistence\Eloquent\EloquentTypeRepository;
...
final class IAMServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(HotelRepository::class, EloquentHotelRepository::class);
