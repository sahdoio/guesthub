...
<template>
    <div>
        <div class="mb-6 flex items-center gap-4">
            <a href="/portal/profile" class="text-gray-500 hover:text-gray-700">&larr; Back</a>
        ...
        <div class="bg-white rounded-lg shadow max-w-2xl">
            <form @submit.prevent="submit" class="p-6 space-y-5">
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <a href="/portal/profile" class="text-sm text-gray-500 hover:text-gray-700">Cancel</a>
                </div>
            </form>
        </div>
    </div>
