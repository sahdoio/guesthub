        ...
        <div class="bg-white rounded-lg shadow">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ $t('reservation.guest') }}</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr v-for="r in reservations" :key="r.id" class="hover:bg-gray-50">
                        <td class="px-6 py-4 text-sm">
                            <div class="font-medium text-gray-900">{{ r.guest.full_name }}</div>
                            <div class="text-gray-500">{{ r.guest.email }}</div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700">
                            {{ r.period.check_in }} &rarr; {{ r.period.check_out }}
                            <div class="text-gray-500">{{ r.period.nights }} {{ r.period.nights !== 1 ? $t('reservation.nights') : $t('reservation.nights') }}</div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700">
