                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-2" v-if="form.preferences.length > 0">
                        <span
                            ...
                            :key="index"
                            class="inline-flex items-center px-3 py-1.5 text-sm bg-indigo-50 text-indigo-700 rounded-lg font-medium"
                        >
                            {{ pref }}
                            <button
                                type="button"
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            type="button"
                            @click="addPreference"
                            class="px-3 py-2 text-sm border border-gray-200 rounded-lg hover:bg-gray-50 shadow-sm"
                        >
